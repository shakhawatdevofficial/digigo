...
@section('title', 'Add New User - DigiGo Admin')
...
<div class="space-y-6 max-w-4xl mx-auto">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <h1 class="text-xl font-bold text-zinc-900 dark:text-white mt-2">Create New User Account</h1>
        </div>
    </div>
    ...
    <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-white dark:bg-brand-cardDark rounded-3xl border border-cream-200 dark:border-brand-borderDark p-6 sm:p-8 shadow-sm space-y-6">
            <div class="flex items-center gap-3 pb-4 border-b border-cream-200 dark:border-brand-borderDark">
                ...
                <div>
                    <h2 class="text-sm font-bold text-zinc-900 dark:text-white">Account Details</h2>
                    <p class="text-[11px] text-zinc-500 dark:text-zinc-400">Fill in the information below to create an administrator or customer account.</p>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="flex items-center gap-4">
                    <div id="photoPreviewContainer" class="w-16 h-16 rounded-2xl bg-cream-100 dark:bg-zinc-800 border-2 border-dashed border-cream-200 dark:border-zinc-700 flex items-center justify-center text-zinc-400 overflow-hidden shrink-0">
