...
@section('title', 'Add New Product - DigiGo Admin')
@section('page_title', 'Add New Product')

@section('content')
<!-- Include jQuery & Summernote Lite for Rich HTML Editing (Headings, Tables, Bold, Underline, Highlight, Images) -->
...
<div class="space-y-6 max-w-6xl mx-auto">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <h1 class="text-xl font-bold text-zinc-900 dark:text-white mt-2">Add New Digital Product</h1>
        </div>
    </div>
                ...
                <div class="bg-white dark:bg-brand-cardDark rounded-3xl border border-cream-200 dark:border-brand-borderDark p-6 shadow-sm space-y-4">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            id="name" 
                            value="{{ old('name') }}" 
                            placeholder="e.g. Office 365 Personal" 
                            required
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            id="slug" 
                            value="{{ old('slug') }}" 
                            placeholder="office-365-personal" 
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            rows="2" 
                            placeholder="e.g. Includes 1TB to 5TB OneDrive storage with full premium apps suite."
                ...
                <div class="bg-white dark:bg-brand-cardDark rounded-3xl border border-cream-200 dark:border-brand-borderDark p-6 shadow-sm space-y-4">
                    ...
                    <div class="space-y-3">
                        ...
                        <label class="block w-full text-center py-2 px-4 bg-cream-100 dark:bg-zinc-800 hover:bg-cream-200 dark:hover:bg-zinc-700 text-zinc-700 dark:text-zinc-200 rounded-xl text-xs font-bold cursor-pointer transition-colors">
                            <i class="fa-solid fa-image mr-1 text-amber-500"></i> Choose Image
