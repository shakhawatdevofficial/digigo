...
Route::middleware(['auth', 'role:admin'])->prefix('/admin')->name('admin.')->group(function () {
    ...
    Route::prefix('/customization')->name('customization.')->group(function () {
        ...
        Route::get('/footer', [CustomizationController::class, 'footer'])->name('footer');
        Route::post('/footer', [CustomizationController::class, 'updateFooter'])->name('footer.update');
        Route::get('/contact', [CustomizationController::class, 'contact'])->name('contact');
        Route::post('/contact', [CustomizationController::class, 'updateContact'])->name('contact.update');
        Route::get('/seo', [CustomizationController::class, 'seo'])->name('seo');
        Route::post('/seo', [CustomizationController::class, 'updateSeo'])->name('seo.update');
    });
});
